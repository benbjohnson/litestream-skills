...
/var/backups/app/
└── ltx/
    ├── 0/                    # Level 0 (raw sync files)
    │   ├── 00000001-00000001.ltx
    │   ├── 00000002-00000002.ltx
    │   └── ...
    ├── 1/                    # Level 1 (first compaction)
    │   └── 00000001-00001000.ltx
    ├── 2/                    # Level 2 (further compaction)
    │   └── 00000001-00010000.ltx
    └── 9/                    # Snapshots
        └── 00000001-00123456.ltx
```
...
### Files not appearing
- Check the full path including ltx/ subdirectories
- Verify sync-interval has elapsed
- Look for .ltx files in level directories (0/, 1/, etc.)
