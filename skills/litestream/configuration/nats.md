...
| `max-reconnects` | -1 | Max reconnection attempts (-1 = unlimited) |
| `reconnect-wait` | 2s | Wait between reconnects |
| `reconnect-jitter` | 100ms | Random jitter for reconnects |
| `reconnect-buf-size` | 8MB | Reconnect buffer size |
| `timeout` | 10s | Connection timeout |
| `ping-interval` | 2m | Ping interval for keepalive |
| `max-pings-out` | 2 | Max pings without response |
